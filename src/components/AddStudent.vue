<template>
  <div class="add-student">
    <nav class="navbar navbar-light bg-info">
      <a class="navbar-brand">StudentSmart</a>
      <form class="form-inline">
      <button class="btn btn-outline-light my-2 my-sm-0" type="submit">
        <router-link :to="{name: 'GetStudents'}" class="text-light">See Students</router-link>
      </button>
  </form>
</nav>
            ...
            <form class="appointment-form" id="appointment-form" @submit.prevent="Register">
              <div class="alert-primary" v-if="feedback">{{feedback}}
                ...
                <div class="form-group-1">
                    ...
                    <input type="number" name="phone_number" id="phone_number" placeholder="Phone number" v-model="phone"/>
                    <div class="select-list">
                      <label for="path" style="color:#ddd;">Path</label>
                        <select name="course_type" id="course_type" v-model="path">
